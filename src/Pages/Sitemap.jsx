...
<map name="image-map">
    ...
    <Link to='/global_operation'><area target="_blank" alt="Global Operation" title="Global Operation" href="" coords="150,85,360,120" shape="rect"/></Link>
    ...
    <Link to='/vision_mission'><area target="_blank" alt="Vision &amp; Mission" title="Vision &amp; Mission"  coords="80,173,260,205" shape="rect"/></Link>
    ...
    <Link to='/message_from_chairmen'><area target="_blank" alt="Message from Chairman" title="Message from Chairman"  coords="76,399,259,433" shape="rect"/></Link>
    <Link to='/by_trade_name'><area target="_blank" alt="By Trade Name" title="By Trade Name"  coords="314,171,502,207" shape="rect"/></Link>
    <Link to='/by_generic_name'><area target="_blank" alt="By Generic Name" title="By Generic Name"  coords="316,248,502,283" shape="rect"/></Link>
    ...
    <Link to='/our_distribution_network'><area target="_blank" alt="Our Distribution Network" title="Our Distribution Network" coords="560,474,743,509" shape="rect"/></Link>
    ...
    <Link to='/social_media_post'><area target="_blank" alt="Social Media Post" title="Social Media Post"  coords="788,322,977,360" shape="rect"/></Link>
    ...
    <Link to='/our_distribution_network'><area target="_blank" alt="Our Distribution Network" title="Our Distribution Network"  coords="1018,172,1205,211" shape="rect"/></Link>
...
<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 1380 511">
  ...
  </Link><Link to="/social_media_post">
    <rect x="782" y="317" fill="#fff" opacity="0" width="193" height="50"></rect>
  </Link><Link to="/message_from_chairmen">
