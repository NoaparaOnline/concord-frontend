...
const Affiliates = () => {
    ...
    return (
        ...
        <Slider {...properties}  className={"slick-slide-affiliates"}>
          <div className="carddivslider "><img className="img-fluid " src={'https://www.ri-demo.co/concord/final-2/wp-content/uploads/2021/04/roche.jpg'}/></div>
          <div className="carddivslider"><img className="img-fluid " src={'https://www.ri-demo.co/concord/final-2/wp-content/uploads/2021/04/brist.jpg'}/></div>
          <div className="carddivslider"><img className="img-fluid " src={'https://www.ri-demo.co/concord/final-2/wp-content/uploads/2021/04/johnson.jpg'}/></div>
          <div className="carddivslider"><img className="img-fluid " src={'https://www.ri-demo.co/concord/final-2/wp-content/uploads/2021/04/novar.jpg'}/></div>
          <div className="carddivslider"><img className="img-fluid " src={'https://www.ri-demo.co/concord/final-2/wp-content/uploads/2021/04/phizer.jpg'}/></div>
          <div className="carddivslider"><img className="img-fluid " src={'https://www.ri-demo.co/concord/final-2/wp-content/uploads/2021/04/sonafi.jpg'}/></div>
        </Slider>
          </div>
                    </div>
                </div>
