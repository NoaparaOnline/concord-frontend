...
const SingleNotificationCard = ({backgroundcolorchat ,userimg ,colorchattext}) => {
    ...
    <div class="card mt-3 p-1">
        <div class="media">
        <div className="rounded-circle p-2"><img alt="" className="rounded-square p-1 mx-2 mt-1" style={{backgroundColor:'#fff',borderRadius:'7px' ,border:'1px solid #0066b3'}} src={icon} height="50px" width="50px" /></div> 
