        ...
        <div className="col-lg-8 section-card-border">
          ...
          <div className="section-card-position">
            <div className="section-card-overlay">
              <h6 className="section-card-subHead">
                {t("globaloperation.what_we_do_text")}
              </h6>
              <h3 className="section-card-heading p-0">
                {t("globaloperation.manufacturing_text")}
              </h3>
              <h3 className="section-card-heading p-0">
                {t("globaloperation.exporting_text")}
              </h3>
              <h3 className="section-card-heading p-0">
                {t("globaloperation.serving_text")}
              </h3>
            </div>
            <Link
              to="/"
