        ...
        <div className="col-lg-8 section-card-border">
          ...
          <div className="section-card-position">
            <div className="section-card-overlay">
              <h6 className="section-card-subHead" style={{fontSize: isDesktoplg ? "" : "12px" }}>{t("globaloperation.what_we_do_text")}</h6>
              <h3 className="section-card-heading p-0" style={{fontSize: isDesktoplg ? "" : "12px" }}>{t("globaloperation.manufacturing_text")}</h3>
              <h3 className="section-card-heading p-0" style={{fontSize: isDesktoplg ? "" : "12px" }}>{t("globaloperation.exporting_text")}</h3>
              <h3 className="section-card-heading p-0" style={{fontSize: isDesktoplg ? "" : "12px" }}>{t("globaloperation.serving_text")}</h3>
            </div>
            <Link
              to="/"
          ...
          <div className="card card_custom">
            <div className="card-body">
              <h1 className="card-title colrry">
                {t("globaloperation.global_operation_text")}
              </h1>
              <img
                src={imgss}
