          ...
          <footer className="text-center text-lg-start text-white">
            <div className="container p-1">
              ...
              <div className="socialiconm">
                ...
                <div className="col-lg-3 col-md-6 d-xs-none mb-4 mb-md-0 second2 ">
                ...
                <div className="col-lg-3 col-md-6 mb-4 mb-md-0 ">
                  ...
                  <ul className="list-unstyled">
                    <li className="">
                      <span className="Typograpy_lastblock_Span">Call :</span>{" "}
                      <span>+8801991145006</span>
                    </li>
                    <li className="">
                    ...
                    <li className="mb-2">
                      ...
                      <span className="ms-2">
                        <Link to='https://www.freecounterstat.com" title="website hits counter'>
                          <img
                            src="https://counter10.stat.ovh/private/freecounterstat.php?c=wg2el4krc3mzdqf834cy12ftxqsuyh4l"
                            border="0"
                            title="website hits counter"
