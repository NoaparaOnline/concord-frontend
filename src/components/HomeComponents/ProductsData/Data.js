...
export const data = [
  {
    ...
    backpagelink: "/by-generic-name",
    innerMainHeading: "Holicef® Injection",
    innerComposition: "Ceftriaxone BP",
    innerData: [
      {
        innerHead: "COMPOSITION",
        innerData: `Holicef® 250 mg IM Injection: Each vial contains Ceftriaxone Sodium BP eqvt. to Ceftriaxone 250 mg. Each ampoule contains 2 ml Lidocaine Hydrochloride 1% BP. 
      ...
      },
      {
        ...
        innerData: `Adults: The dosage and duration of therapy shall be established depending on type and severity of infection and the condition of the patient.
          The recommended daily dosage in different infections is as follows-
          `,
        istable: true,
        table: {
          headers: ["Infection", "Dosage"],
          body: [
            [
              "Pneumonia, UTI, gynaecological, such as endometritis, skin and soft tissue infections",
          ...
          //         [
          //           `Pneumonia, UTI, gynaecological, infections
          //        such as endometritis, skin and
