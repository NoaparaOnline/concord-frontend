        ...
        <div className="row  ">
          {card.map((ob, index) => (
            <React.Fragment key={ob.id}>
              <div  className={index===0  ? `col-xl-2 col-lg-4  offset-xl-1 d-none d-lg-block d-md-none  custome-card-test mb-4` 
             
              : `col-xl-2 col-lg-4  d-none d-lg-block d-md-none  custome-card-test mb-4`}>
                <FlipCard card={ob} />
              </div>
